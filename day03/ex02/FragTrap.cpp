...
void	FragTrap::meleeAttack(std::string const &target) {
	...
	"Heyyaaaaaah!" << " ";
	std::cout << "<" << this->_type << " " << this->_name
	<< " performs melee attack aginst " << target << ", causing "
...
void	FragTrap::funzerker(std::string const &target) {
	...
	std::cout << "<" << this->_type << " " << this->_name
	<< " use funzerker aginst " << target << ", causing "
...
void	FragTrap::miniontrap(std::string const &target) {
	...
	<< " ";
	std::cout << "<" << this->_type << " " << this->_name
	<< " sets the minion trap aginst " << target << ", causing "
...
void	FragTrap::blightbot(std::string const &target) {
	...
	std::cout << "<" << this->_type << " " << this->_name
	<< " use blightbot aginst " << target << ", causing "
